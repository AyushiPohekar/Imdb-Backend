export const data = [
  {
    ...
    actors: [
      ...
      },
      {
        ...
        dob: "13 June 1953",
        gender: "Male",
        bio: "Timothy Alan Dick, known professionally as Tim Allen, is an American actor and comedian. He is known for playing Tim ",
      },
      {
        name: "Don Rickles",
        dob: "8 May 1926",
        gender: "Male",
        bio: "Donald Jay Rickles was an American stand-up comedian and actor. He became known primarily for his insult comedy. His film roles include Run Silent, Run Deep, Enter Laughing, Kelly's Heroes, Casino. From 1976 to 1978, Rickles had a two-season starring role in the NBC television",
      },
    ],
    producer: {
  ...
  },
  {
    ...
    producer: {
      ...
      dob: "20 July 1954 ",
      gender: "Male",
      bio: "John Andrew Davis (born July 20, 1954) is an American film producer and founder of Davis Entertainment",
    },
  },
  {
    movie: {
    ...
    producer: {
      ...
      dob: "3 jan 2018 ",
      gender: "Male",
      bio: "Ezra Swerdlow (March 2, 1953 – January 23, 2018)[1] was an American film producer and production manager.In 1980, he served as a unit manager on the Woody Allen film Stardust Memories.[2] He co-owned Schindler/Swerdlow Productions in New York.",
    },
  },

  {
    movie: {
      ...
      poster_path:
        "https://resizing.flixster.com/hgrC8THZ4EWKZv21jjyrtpbigqQ=/300x300/v2/https://flxt.tmsimg.com/assets/p10907_v_v13_am.jpB",
  ...
  },
  {
    movie: {
      ...
      poster_path:
        "https://resizing.flixster.com/EoXzi7vZEPR_9gJB8CpTBTEIL0g=/206x305/v2/https://flxt.tmsimg.com/assets/p26553_p_v8_ay.jpg",
  ...
  //     runtime: 170,
  //     spoken_languages:
  //       "[{'iso_639_1': 'en', 'name': 'English'}, {'iso_639_1': 'es', 'name': 'Espa ol'}]",
  //     status: "Released",
  ...
  //     runtime: 127,
  //     spoken_languages:
  //       "[{'iso_639_1': 'fr', 'name': 'Fran ais'}, {'iso_639_1': 'en', 'name': 'English'}]",
  //     status: "Released",
  //     tagline:
  ...
  //     homepage: "http://www.mgm.com/view/movie/757/Goldeneye/",
  //     id: 710,
  //     imdb_id: "tt0113189",
  //     original_language: "en",
  ...
  //     runtime: 130,
  //     spoken_languages:
  //       "[{'iso_639_1': 'en', 'name': 'English'}, {'iso_639_1': 'ru', 'name': 'P??????'}, {'iso_639_1': 'es', 'name': 'Espa ol'}]",
  //     status: "Released",
  ...
  //     production_companies:
  //       "[{'name': 'Universal Pictures', 'id': 33}, {'name': 'L gende Entreprises', 'id': 10898}, {'name': 'Syalis DA', 'id': 11583}, {'name': 'De Fina-Cappa', 'id': 11584}]",
  //     production_countries:
  //       "[{'iso_3166_1': 'FR', 'name': 'France'}, {'iso_3166_1': 'US', 'name': 'United States of America'}]",
  ...
  //     adult: "False",
  //     belongs_to_collection:
  //       "{'id': 3167, 'name': 'Ace Ventura Collection', 'poster_path': '/qCxH543pScFed1CycwJ1nVgrkOc.jpg', 'backdrop_path': '/bswWgdDsLu0fhWMYUzLF8XgiK4h.jpg'}",
  //     budget: 30000000,
  //     genres:
  ...
  //     spoken_languages: "[{'iso_639_1': 'en', 'name': 'English'}]",
  //     status: "Released",
  //     tagline: "New animals. New adventures. Same hair.",
